...
class FunchandTest extends AbstractTestCase
{
    ...
    function test_ope_func()
    {
        ...
        // 例外系
        that(ope_func)('hogera')->wasThrown('is not defined');
    }
    ...
    function test_reflect_callable()
    {
        ...
        // そんなものは存在しない
        that(reflect_callable)('hogefuga')->wasThrown('does not exist');

        // そもそも形式がおかしい
        that(reflect_callable)([])->wasThrown('is not callable');
    }
    ...
    function test_call_safely()
    {
        ...
        // エラーが出たら例外を投げる
        that(call_safely)(fn() => (string) [])->wasThrown('Array to string conversion');
    ...
    function test_ob_capture()
    {
        ...
        // 処理中に飛んだ例外が飛ぶ
        that(ob_capture)(function ($v) { throw new \Exception('inob'); },
            'hoge')->wasThrown('inob');
        // ob レベルは変わらない
        that(ob_get_level())->is($current);
    }
    ...
    function test_by_builtin()
    {
        ...
        that(by_builtin)('', '')->wasThrown('backtrace');
    }
    ...
    function test_function_alias()
    {
        ...
        // 例外
        that(function_alias)(function () { }, 'xx')->wasThrown('must not be object');
        that(function_alias)('x', 'xx')->wasThrown('does not exist');
        that(function_alias)([new \Concrete('u'), 'getName'], 'xx')->wasThrown('non-static method');
        that(function_alias)('implode', 'implode')->wasThrown('already declared');
    }
