...
')->wasThrown(new \ParseError(<<<ERR
    ...
    function test_namespace_parse()
    {
        ...
        that($actual)->as('actual:' . var_export2($actual, true))->is([
            "vendor\\NS"   => [
                ...
                "alias"    => [
                    ...
                    "nsI"                    => "vendor\\NS\\nsI",
                    "nsT"                    => "vendor\\NS\\nsT",
                    "Space\\C"               => "vendor\\NS\\Space\\C",
                    "Unknown1"               => "vendor\\NS\\Unknown1",
                    "unknown\\Unknown2"      => "vendor\\NS\\unknown\\Unknown2",
                    "GlobalAttr"             => "vendor\\NS\\GlobalAttr",
                    "Space\\Attr"            => "vendor\\NS\\Space\\Attr",
                    "PropertyType"           => "vendor\\NS\\PropertyType",
                    "Sub\\PropertyType"      => "vendor\\NS\\Sub\\PropertyType",
                    "ArgumentType"           => "vendor\\NS\\ArgumentType",
                    "Sub\\ArgumentType"      => "vendor\\NS\\Sub\\ArgumentType",
                    "ReturnType"             => "vendor\\NS\\ReturnType",
                    "Sub\\ReturnType"        => "vendor\\NS\\Sub\\ReturnType",
                    "Unknown"                => "vendor\\NS\\Unknown",
                    "UnknownClass1"          => "vendor\\NS\\UnknownClass1",
                    "Sub\\UnknownClass2"     => "vendor\\NS\\Sub\\UnknownClass2",
                    "UnknownInterface1"      => "vendor\\NS\\UnknownInterface1",
                    "Sub\\UnknownInterface2" => "vendor\\NS\\Sub\\UnknownInterface2",
                    "UnknownTrait1"          => "vendor\\NS\\UnknownTrait1",
                    "Sub\\UnknownTrait2"     => "vendor\\NS\\Sub\\UnknownTrait2",
                ],
            ],
            "other\\space" => [
                "const"    => [
        ...
        // Utility は全てのコードが含まれてかつクラス化しているので、パース失敗に気付きやすい
        $actual = namespace_parse(__DIR__ . '/../../../src/Utility.php');
        that($actual)->is([
            "ryunosuke\\Functions" => [
                "const"    => [],
                "function" => [],
                "alias"    => [
                    "Utility" => "ryunosuke\\Functions\\Utility",
                ],
            ],
        ]);
