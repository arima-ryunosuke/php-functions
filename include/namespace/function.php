...
if (!isset($excluded_functions['in_array_and']) && (!function_exists('ryunosuke\\Functions\\in_array_and') || (new \ReflectionFunction('ryunosuke\\Functions\\in_array_and'))->isInternal())) {
    /**
     * in_array の複数版（AND）
     *
...
if (!isset($excluded_functions['in_array_or']) && (!function_exists('ryunosuke\\Functions\\in_array_or') || (new \ReflectionFunction('ryunosuke\\Functions\\in_array_or'))->isInternal())) {
    /**
     * in_array の複数版（OR）
     *
...
if (!isset($excluded_functions['array_implode']) && (!function_exists('ryunosuke\\Functions\\array_implode') || (new \ReflectionFunction('ryunosuke\\Functions\\array_implode'))->isInternal())) {
    /**
     * 配列の各要素の間に要素を差し込む
     *
...
if (!isset($excluded_functions['array_sprintf']) && (!function_exists('ryunosuke\\Functions\\array_sprintf') || (new \ReflectionFunction('ryunosuke\\Functions\\array_sprintf'))->isInternal())) {
    /**
     * キーと値で sprintf する
     *
     * 配列の各要素を文字列化して返すイメージ。
...
if (!isset($excluded_functions['array_strpad']) && (!function_exists('ryunosuke\\Functions\\array_strpad') || (new \ReflectionFunction('ryunosuke\\Functions\\array_strpad'))->isInternal())) {
    /**
     * 配列のキー・要素に文字列を付加する
     *
...
if (!isset($excluded_functions['array_find']) && (!function_exists('ryunosuke\\Functions\\array_find') || (new \ReflectionFunction('ryunosuke\\Functions\\array_find'))->isInternal())) {
    /**
     * array_search のクロージャ版のようなもの
     *
...
if (!isset($excluded_functions['array_maps']) && (!function_exists('ryunosuke\\Functions\\array_maps') || (new \ReflectionFunction('ryunosuke\\Functions\\array_maps'))->isInternal())) {
    /**
...
if (!isset($excluded_functions['array_shuffle']) && (!function_exists('ryunosuke\\Functions\\array_shuffle') || (new \ReflectionFunction('ryunosuke\\Functions\\array_shuffle'))->isInternal())) {
    /**
...
if (!isset($excluded_functions['detect_namespace']) && (!function_exists('ryunosuke\\Functions\\detect_namespace') || (new \ReflectionFunction('ryunosuke\\Functions\\detect_namespace'))->isInternal())) {
    /**
...
if (!isset($excluded_functions['dirname_r']) && (!function_exists('ryunosuke\\Functions\\dirname_r') || (new \ReflectionFunction('ryunosuke\\Functions\\dirname_r'))->isInternal())) {
    /**
...
if (!isset($excluded_functions['path_is_absolute']) && (!function_exists('ryunosuke\\Functions\\path_is_absolute') || (new \ReflectionFunction('ryunosuke\\Functions\\path_is_absolute'))->isInternal())) {
    /**
     * パスが絶対パスか判定する
     *
     * Example:
...
if (!isset($excluded_functions['path_resolve']) && (!function_exists('ryunosuke\\Functions\\path_resolve') || (new \ReflectionFunction('ryunosuke\\Functions\\path_resolve'))->isInternal())) {
    /**
     * パスを絶対パスに変換して正規化する
     *
...
if (!isset($excluded_functions['path_normalize']) && (!function_exists('ryunosuke\\Functions\\path_normalize') || (new \ReflectionFunction('ryunosuke\\Functions\\path_normalize'))->isInternal())) {
    /**
     * パスを正規化する
     *
...
if (!isset($excluded_functions['minimum']) && (!function_exists('ryunosuke\\Functions\\minimum') || (new \ReflectionFunction('ryunosuke\\Functions\\minimum'))->isInternal())) {
    /**
     * 引数の最小値を返す
     *
...
if (!isset($excluded_functions['maximum']) && (!function_exists('ryunosuke\\Functions\\maximum') || (new \ReflectionFunction('ryunosuke\\Functions\\maximum'))->isInternal())) {
    /**
     * 引数の最大値を返す
     *
     * - 配列は個数ではなくフラット展開した要素を対象にする
...
if (!isset($excluded_functions['mode']) && (!function_exists('ryunosuke\\Functions\\mode') || (new \ReflectionFunction('ryunosuke\\Functions\\mode'))->isInternal())) {
    /**
     * 引数の最頻値を返す
     *
...
if (!isset($excluded_functions['mean']) && (!function_exists('ryunosuke\\Functions\\mean') || (new \ReflectionFunction('ryunosuke\\Functions\\mean'))->isInternal())) {
    /**
     * 引数の相加平均値を返す
     *
...
if (!isset($excluded_functions['median']) && (!function_exists('ryunosuke\\Functions\\median') || (new \ReflectionFunction('ryunosuke\\Functions\\median'))->isInternal())) {
    /**
     * 引数の中央値を返す
     *
...
if (!isset($excluded_functions['average']) && (!function_exists('ryunosuke\\Functions\\average') || (new \ReflectionFunction('ryunosuke\\Functions\\average'))->isInternal())) {
    /**
     * 引数の意味平均値を返す
     *
...
if (!isset($excluded_functions['sum']) && (!function_exists('ryunosuke\\Functions\\sum') || (new \ReflectionFunction('ryunosuke\\Functions\\sum'))->isInternal())) {
    /**
     * 引数の合計値を返す
     *
     * - is_numeric でない値は除外される（計算結果に影響しない）
...
if (!isset($excluded_functions['random_at']) && (!function_exists('ryunosuke\\Functions\\random_at') || (new \ReflectionFunction('ryunosuke\\Functions\\random_at'))->isInternal())) {
    /**
     * 引数をランダムで返す
     *
     * - 候補がない場合はエラーではなく例外を投げる
...
if (!isset($excluded_functions['probability']) && (!function_exists('ryunosuke\\Functions\\probability') || (new \ReflectionFunction('ryunosuke\\Functions\\probability'))->isInternal())) {
    /**
     * 一定確率で true を返す
     *
...
if (!isset($excluded_functions['str_subreplace']) && (!function_exists('ryunosuke\\Functions\\str_subreplace') || (new \ReflectionFunction('ryunosuke\\Functions\\str_subreplace'))->isInternal())) {
    /**
     * 指定文字列を置換する
     *
...
if (!isset($excluded_functions['str_between']) && (!function_exists('ryunosuke\\Functions\\str_between') || (new \ReflectionFunction('ryunosuke\\Functions\\str_between'))->isInternal())) {
    /**
     * 指定文字で囲まれた文字列を取得する
     *
...
if (!isset($excluded_functions['try_finally']) && (!function_exists('ryunosuke\\Functions\\try_finally') || (new \ReflectionFunction('ryunosuke\\Functions\\try_finally'))->isInternal())) {
    /**
     * try ～ finally 構文の関数版
     *
...
if (!isset($excluded_functions['error']) && (!function_exists('ryunosuke\\Functions\\error') || (new \ReflectionFunction('ryunosuke\\Functions\\error'))->isInternal())) {
    /**
     * エラー出力する
     *
...
if (!isset($excluded_functions['var_type']) && (!function_exists('ryunosuke\\Functions\\var_type') || (new \ReflectionFunction('ryunosuke\\Functions\\var_type'))->isInternal())) {
    /**
